...
export const SettingsMainSection = (): JSX.Element => {
  ...
  return (
    <section className="w-full h-full bg-white overflow-auto p-12">
        ...
        <div className="flex justify-end mt-4">
          <div className="relative">
            ...
            <Input
              ...
              placeholder="SearchIcon all Copilot settings"
            />
          </div>
        </div>
      </div>
      ...
      <div className="w-full bg-white">
        ...
        {settingsData.map((setting, index) => (
          <div
            key={index}
            className="flex border-b border-[#ededed] h-[38px] items-center"
          >
            <div className="w-[450px] flex items-center">
              <img
